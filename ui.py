...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle("J.A.R.V.I.S - Arc Reactor Edition")
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("ARC REACTOR", C.PRI_DIM))
        lay.addStretch()
        ...
        mid.addWidget(title)
        sub = QLabel("Arc Reactor Edition")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("Created by Roshab Bhandari  ·  ARC REACTOR EDITION  ·  ONLINE"))
        lay.addStretch()
        lay.addWidget(_fl("© Roshab Bhandari", C.PRI_DIM))
        return w
