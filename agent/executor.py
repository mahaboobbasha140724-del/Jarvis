...
def _detect_language(text: str) -> str:
    from core.gemini_wrapper import ModernGenerativeModel
    model = ModernGenerativeModel("gemini-2.5-flash-lite")
    try:
        response = model.generate_content(
...
def _translate_to_goal_language(content: str, goal: str) -> str:
    ...
    try:
        from core.gemini_wrapper import ModernGenerativeModel
        model = ModernGenerativeModel("gemini-2.5-flash")
...
class AgentExecutor:
    ...
    def _summarize(self, goal: str, completed_steps: list, speak: Callable | None) -> str:
        ...
        try:
            from core.gemini_wrapper import ModernGenerativeModel
            model     = ModernGenerativeModel(model_name="gemini-2.5-flash-lite")
