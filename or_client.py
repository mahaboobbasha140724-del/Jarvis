...
class OpenRouterClient:
    ...
    def chat(
        ...
        prompt: str,
        system: str = (
            "You are a component of J.A.R.V.I.S: Arc Reactor Edition, a cinematic AI assistant created by Roshab Bhandari. "
...
if __name__ == "__main__":
    print("=" * 55)
    print("  JARVIS Arc Reactor — OpenRouter Client Self-Test")
    print("=" * 55)
